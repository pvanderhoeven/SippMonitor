...
public class SippMonitorMscListener extends SippMonitorBaseListener {
    ...
    public SippMonitorMscListener(PriorityQueue<SipMessage> messages, ListenerType type) {
    ...
    @Override
    public void enterTimeStamp(@NotNull SippMonitorParser.TimeStampContext ctx) {
    ...
    @Override
    public void enterDirectionLine(@NotNull SippMonitorParser.DirectionLineContext ctx) {
        currentDirection = ctx.DIRECTION_LINE().getText().contains("sent") ? Direction.SENT : Direction.RECEIVED;
    }

    @Override
    public void enterSipResponse(@NotNull SippMonitorParser.SipResponseContext ctx) {
    ...
    @Override
    public void enterSipRequest(@NotNull SippMonitorParser.SipRequestContext ctx) {
